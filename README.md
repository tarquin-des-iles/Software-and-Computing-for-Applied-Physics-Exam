...
Pollen analysis is carried out for each layer of the core. The information obtained from this allows palaeopalynologists to reconstruct the area's vegetation dynamic, and subsequently the climate evolution of that area.
...
Having an obscure and predefinied software that furnished them those two statistical structures, they requested my help to construct a hands-on tool code with Python and Github they could use and modify to manipulate the data. 
...
- In the file [roc](...Link...), we will find the functions that enable the statistical process to obtain the Rate of Change graphics.

- In the file [testing](...Link...), there are all the simple test to verify the good functionning of both pollinic and RoC functions. 
